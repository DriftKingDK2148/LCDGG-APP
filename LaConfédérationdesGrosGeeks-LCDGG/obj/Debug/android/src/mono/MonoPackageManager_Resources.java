...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "LaConfédérationdesGrosGeeks_LCDGG.dll" comes first in this list. */
		"LaConfédérationdesGrosGeeks_LCDGG.dll",
		"materialloadingprogressbar-0.5.6.dll",
